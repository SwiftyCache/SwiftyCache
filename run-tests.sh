...
xcodebuild clean test -workspace SwiftyCache.xcworkspace -scheme SwiftyCache-iOS -destination "platform=iOS Simulator,name=iPhone 6 Plus" -enableCodeCoverage YES
